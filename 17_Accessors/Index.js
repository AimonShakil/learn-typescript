...
class User {
    constructor(email, name) {
        this.email = email;
        this.name = name;
        this._courseCount = 1; // we do getter and setter for this ex if we allow to access this property we do it through getter and setter adn excess it through method so directly value cannot be manipuated 
        this.city = "Islamabad";
    }
    deleteToken() {
