...
obj.bar = 100;
obj = "Hello";
const n = obj; // None of these lines throw compiler error , using any disabled type checking
// Any
let myval; // defies the purpose of TS which is type checking
myval = true; // OK
myval = 42; // OK
myval = "hey!"; // OK
myval = []; // OK
...
//Unknown
let value; // also states that value dont know at this time so allow all types of values
value = true; // OK
value = 42; // OK
value = "hey!"; // OK
value = []; // OK
