...
//real life objects , Class blueprint
    ...
    class Student {  // class is keyword
        id:number;
        //name : string = "Aimon"; //statics values, should be provided by users we make constructor
        program:string;   // Properties or Fields
    
        constructor (id : number , program :string) {
    this.id = id;
...
class person {
    ...
    constructor (race : string, origin : string, religion : string) {
    this.race = race;
    this.origin = origin;
...
let h: Human = new Human("Tom"); // object are being formed h, a and r
