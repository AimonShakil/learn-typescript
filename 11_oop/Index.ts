...
class User{  // CLASS
    ...
    email : string;
    city : string;
   private readonly DBID : number = 12
    address : string = "H.2, st 5"
...
constructor(type : string, model : string, price : string) {
    this.type = "vehicle";
    this.model = "2020";
    this.price = "$200k"
}
...
constructor (gender: string , nationality : string) {
    this.gender = "Male";
